                          ...
                          const size_t k, const size_t MAT_COLS, int *d_c)
{
    ...
    T finddistance1 = 0;
    T finddistance2 = 0;
    judge_center(d_vals, d_EigVecs+(MAT_COLS-1)*MAT_COLS, MAT_COLS, true, finddistance1);
    judge_center(d_vals, d_EigVecs+(MAT_COLS-1)*MAT_COLS, MAT_COLS, false, finddistance2);
